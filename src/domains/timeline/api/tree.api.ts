...
const mockTreeData: TreeNodeData[] = [
  ...
  { id: '4', name: 'HR & Operations', level: 1, hasChildren: false }, // Level 1 leaf
  { id: '5', name: 'Finance', level: 1, hasChildren: false }, // Level 1 leaf
  ...
  { id: '1-4', name: 'Mobile', level: 2, parentId: '1', hasChildren: false }, // Level 2 leaf
  { id: '1-5', name: 'QA', level: 2, parentId: '1', hasChildren: false }, // Level 2 leaf
  
  // Level 2 - Marketing
  { id: '2-1', name: 'Digital Marketing', level: 2, parentId: '2', hasChildren: true },
  { id: '2-2', name: 'Content', level: 2, parentId: '2', hasChildren: true },
  { id: '2-3', name: 'Brand Strategy', level: 2, parentId: '2', hasChildren: false }, // Level 2 leaf
  { id: '2-4', name: 'Events', level: 2, parentId: '2', hasChildren: false }, // Level 2 leaf
  
  // Level 2 - Sales
  { id: '3-1', name: 'Enterprise', level: 2, parentId: '3', hasChildren: true },
  { id: '3-2', name: 'SMB', level: 2, parentId: '3', hasChildren: true },
  { id: '3-3', name: 'Customer Success', level: 2, parentId: '3', hasChildren: false }, // Level 2 leaf
  ...
  { id: '1-1-3', name: 'Design System', level: 3, parentId: '1-1', hasChildren: false }, // Level 3 leaf
  { id: '1-1-4', name: 'Performance', level: 3, parentId: '1-1', hasChildren: false }, // Level 3 leaf
  ...
  { id: '1-2-3', name: 'Microservices', level: 3, parentId: '1-2', hasChildren: false }, // Level 3 leaf
  { id: '1-2-4', name: 'Security', level: 3, parentId: '1-2', hasChildren: false }, // Level 3 leaf
  ...
  { id: '1-3-3', name: 'Monitoring', level: 3, parentId: '1-3', hasChildren: false }, // Level 3 leaf
  
  // Level 3 - Digital Marketing
  { id: '2-1-1', name: 'SEO', level: 3, parentId: '2-1', hasChildren: false }, // Level 3 leaf
  { id: '2-1-2', name: 'SEM', level: 3, parentId: '2-1', hasChildren: false }, // Level 3 leaf
  { id: '2-1-3', name: 'Social Media', level: 3, parentId: '2-1', hasChildren: false }, // Level 3 leaf
  
  // Level 3 - Content
  { id: '2-2-1', name: 'Blog', level: 3, parentId: '2-2', hasChildren: false }, // Level 3 leaf
  { id: '2-2-2', name: 'Video', level: 3, parentId: '2-2', hasChildren: false }, // Level 3 leaf
  { id: '2-2-3', name: 'Documentation', level: 3, parentId: '2-2', hasChildren: false }, // Level 3 leaf
  
  // Level 3 - Enterprise
  { id: '3-1-1', name: 'Fortune 500', level: 3, parentId: '3-1', hasChildren: false }, // Level 3 leaf
  { id: '3-1-2', name: 'Mid-Market', level: 3, parentId: '3-1', hasChildren: false }, // Level 3 leaf
  
  // Level 3 - SMB
  { id: '3-2-1', name: 'Startups', level: 3, parentId: '3-2', hasChildren: false }, // Level 3 leaf
  { id: '3-2-2', name: 'Small Business', level: 3, parentId: '3-2', hasChildren: false }, // Level 3 leaf
  ...
  // Level 4 - Infrastructure (leaf nodes)
