...
            ><dxplm-label
              message="tes.product-item-registration-screentitle"
              text="제품 Item 등록"
          /></dxplm-button>
          <dxplm-button
            primary
...
            large
            @click="handleClickCreateRoadmapItem"
            :disabled="!(store.selectedRoadId && (store.roadmapType === 'TRM' || store.roadmapType === 'CMM'))"
            ><dxplm-label
              message="tes.required-tech-registration-screentitle"
              text="필요기술 등록"
          /></dxplm-button>
          <dxplm-button primary solid large @click="closeLayerAdmin"
            disabled="true"
            ><dxplm-label
...
      <dxplm-search-row>
        <dxplm-search-item
          :label="msg('cmm.organization-label', '조직')"
          class="search-treearea"
        >
          <dxplm-select
...
        </dxplm-search-item>
        <dxplm-search-item>
          <dxplm-checkbox v-model="isHideMode">
            항목있는 레벨만
          </dxplm-checkbox>
        </dxplm-search-item>
      </dxplm-search-row>
...
        </dxplm-search-row>
        <dxplm-search-row>
          <dxplm-search-item v-if="store.roadmapType === 'PRM'" :label="msg('tes.mp-plan-month-input-label', '양산계획월 입력')">
            <dxplm-date-picker
              v-model="search.sopPlanMonth"
              type="month"
              is-string-value
            />
          </dxplm-search-item>
...
import ErmmVisTimelineRoadmap from "../components/ErmmVisTimelineRoadmap.vue";
...
const timelineCompRef = ref(null); // ErmmVisTimeline 컴포넌트 참조
...
    parentId: "",
    orgGroupCode: search.value.organization,
